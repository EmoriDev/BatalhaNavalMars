.data
	...
	atacarColumnMessage: .asciiz "\nDigite a coluna a ser atacada: "
	             ...
	             .align  4 # alinhamento de memoria
...
.text
	...
	playAloneStart:
        ...
        singlePlayerFill:
            	...
            	move     $t7, $zero # $t7: vez do jogador 0   
        		li     $v0, 4        
        		la     $a0, vezJogador  
        		syscall 
        		li     $v0, 1        
        		...
        		syscall 
            		...
            		add     $t7,$t7, 1   # $t7: vez do jogador 0   
        		li     $v0, 4        
        		la     $a0, vezJogador  
        		syscall 
        		li     $v0, 1        
			...
			preenche_matrix:
				...
				li       $t0, 10     # $t0: numero de linhas
				li       $t1, 10     # $t1: numero de colunas
			...
			popular_matriz:            
				...
				addi     $t2, $t2, 1 
				# solicita que o usuario digite um numero da linha
				li     $v0, 4        
				la     $a0, inserir_linha    
				syscall
				li     $v0, 5        
				syscall            
				move     $s0, $v0
				# solicita que o usuario digite um numero da coluna
				li     $v0, 4        
				...
				# calcula o endereco correto do array
